...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'path' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'collate' => null],
        ...
        'status' => ['type' => 'tinyinteger', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '1', 'precision' => null, 'comment' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'sqlite_autoindex_files_1' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-28 20:44:42',
                'modified' => '2018-11-28 20:44:42',
                'status' => 1
            ],
        ];
        parent::init();
